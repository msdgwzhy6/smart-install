...
export default class extends Component { 
    ...
    hide = () => {
        ...
        Animated.timing(this._to, {
            toValue: this.value,
            duration: duration < 200 ? 200 : duration,//240, 
        }).start(() => {
    ...
    show = () => {
        ...
        this.setState({
            ...
            Animated.timing(this._to, {
                toValue: 0,
                duration: duration < 260 ? 260 : duration,//240, 
    ...
    render () {
        return (  
            <Modal transparent={true} onRequestClose={this.hide} visible={this.state.visible}>
                ...
                <Animated.View {...this._panResponder.panHandlers} style={[{backgroundColor: 'white'}, this.props.style, this.style]} >
                    {
                        this.props.children    
                    }
                </Animated.View>
